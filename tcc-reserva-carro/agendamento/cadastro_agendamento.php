...
if (isset($_POST["salvarAgendamento"])) {
    ...
    $login_funcionario_idlogin_funcionario = $_SESSION["usuario_funcionario_logado"];
...
?>
    ...
    <?php
        ...
        $sql = "INSERT INTO agendamento (login_funcionario_idlogin_funcionario,carro_idcarro, cidade, bairro, entrada, saida, horario_entrada, horario_saida, motivo) VALUES ('{$login_funcionario_idlogin_funcionario}','{$carro_idcarro}','{$cidade}', '{$bairro}', '{$data_entrada}', '{$data_saida}', '{$horario_entrada}', '{$horario_saida}', '{$motivo}')";
