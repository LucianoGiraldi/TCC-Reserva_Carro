...
INSERT INTO `carro` (`idcarro`, `placa`, `modelo`, `preco`,`motorizacao`,`ano`,`cor`,`automatico`,`marca`,`imagem`) VALUES
(1, 'teste', 'teste','10.10','teste','2004','vermelho','teste','teste','imagens_carros/Wallpaper.jpg');
...
INSERT INTO `funcionario` (`idfuncionario`, `nome`, `cpf`, `email`, `telefone`, `funcao`, `emprego`, `sexo`,`cep`) VALUES
(1, 'alexei', 112321, '974009076', 0, 'todos', 'todos', 'todos','13232');
